        ...
        <div className="bg-slate-800/50 rounded-3xl border border-slate-700 overflow-hidden">
          ...
          <div className="p-6 md:p-10">
            ...
            {activeTab === 'android' && (
              <div className="space-y-8 animate-in fade-in duration-300">
                <div>
                  <h3 className="text-2xl font-bold mb-4">Installation sur Android</h3>
                  <p className="text-slate-400 mb-6">Pour les appareils Android, <strong>IPTV Smarters Pro</strong> est une solution simple et rapide.</p>
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-lg mb-2">Télécharger l'application</h4>
                        <p className="text-slate-400">Ouvrez Google Play Store, recherchez l'application recommandée par notre support et installez-la sur votre appareil Android.</p>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-primary/20 text-primary flex items-center justify-center shrink-0 font-bold">2</div>
                      <div>
                        <h4 className="font-bold text-lg mb-2">Ouvrir l'application</h4>
                        <p className="text-slate-400">Une fois l'application installée, ouvrez-la pour commencer la configuration de votre abonnement.</p>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-primary/20 text-primary flex items-center justify-center shrink-0 font-bold">3</div>
                      <div>
                        <h4 className="font-bold text-lg mb-2">Connexion avec API</h4>
                        <p className="text-slate-400">Choisissez l'option de connexion avec API puis entrez le code API fourni lors de l'achat.</p>
                      </div>
                    </div>
                  </div>
                </div>
